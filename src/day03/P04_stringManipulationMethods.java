...
public class P04_stringManipulationMethods {
    public static void main(String[] args) {
        ...
        String kelime3=" nasılsın";
        System.out.println(kelime2.concat(kelime3));  //merhaba nasılsın
        System.out.println(10+20+kelime2.concat(kelime3));//30merhaba nasılsın
        System.out.println(kelime2.concat(kelime3)+10+20);// merhaba nasılsın1020
        System.out.println(kelime2.concat(kelime3)+(10+20));// merhaba nasılsın30
        int s1=100;
        ...
        String s3 = " everybody";
        System.out.println(s.concat(s3)); // Hi everybody
        System.out.println("s = " + s); // s = Hi

        s = s.concat(s3);// yani degiskenin kendisine atama yapılırsa degeri kalici degisir.
         ...
         */
        String sA = "Murat BABAYİĞİT";
        String sB = sA + "" ; // Murat BABAYİĞİT
        ...
        String s33=null; // null hic demek
